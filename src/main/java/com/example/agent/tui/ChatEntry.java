...
public record ChatEntry(Role role, String content, String toolName, Instant timestamp) {
  ...
  public enum Role {
    USER, AGENT, TOOL, ERROR, PRERENDERED
  }
  ...
  /**
   * Already-styled content — ChatView emits it verbatim.
   */
  public static ChatEntry prerendered(String content) {
    return new ChatEntry(Role.PRERENDERED, content, null, Instant.now());
  }
}
